...
const CarruselResenas: React.FC = () => {
  return (
    <section className="bg-white flex flex-col text-center sm:p-6 md:p-12 xl:gap-10 xl:p-12">
      ...
      <div className='grid sm:grid-cols-1 sm:gap-5  md:grid-cols-1 md:gap-6 xl:grid-cols-8 xl:gap-8 '>
        <div className='flex flex-col justify-center items-center gap-2 xl:col-span-2'>
            ...
            <p className=' font-sourceSans sm:text-sm md:text-md xl:text-lg'>A base de <strong>+50 reseñas</strong></p>
